...
@interface CAImageScrollView()<UIScrollViewDelegate>
{
    UIImageView *imgView;
...
@implementation CAImageScrollView
...
{
    if (self.i_delegate && [self.i_delegate respondsToSelector:@selector(tappedWithImageScrollView:)])
    {
        [self.i_delegate performSelector:@selector(tappedWithImageScrollView:) withObject:self];
    }
}
